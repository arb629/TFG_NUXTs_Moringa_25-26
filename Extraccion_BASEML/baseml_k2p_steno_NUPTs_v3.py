# ============================================================
# BASEML K2P — M. stenopetala NUPTs filtrados (sin IR)  v3
# Input:  steno_ptld_nuc_noIR.out
# Output: /home/kubuntu/Andrea/TFG/Filtro_Blast_IR/v3/steno/NUPTs/
# Cambios v3:
...
# ── RUTAS ────────────────────────────────────────────────────
out_file       = "/home/kubuntu/Andrea/TFG/Filtro_Blast_IR/steno/steno_ptld_nuc_noIR.out"
nuclear_fasta  = "/home/kubuntu/Andrea/TFG/M_stenopetala/NU/mstenopetalav1_chr.fasta"
organelo_fasta = "/home/kubuntu/Andrea/TFG/M_stenopetala/PT/MORINGASTN.pltd.ctg_kenya.fasta"
output_dir     = "/home/kubuntu/Andrea/TFG/Filtro_Blast_IR/v3/steno/NUPTs"
os.makedirs(output_dir, exist_ok=True)

# ── CARGAR GENOMAS ───────────────────────────────────────────
print("Cargando genomas...")
nuclear_raw  = {rec.id: rec for rec in SeqIO.parse(nuclear_fasta,  "fasta")}
organelo_raw = {rec.id: rec for rec in SeqIO.parse(organelo_fasta, "fasta")}

mapeo_organelo = {"Moringa_stenopetala_Kenya": "Moringa_stenopetala_Kenya_PT"}
organelo = {}
